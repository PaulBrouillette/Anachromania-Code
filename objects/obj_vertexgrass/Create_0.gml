...
grass_rect_hor = rectHorSize; //Horizontal (x) size of rectangle
grass_rect_ver = rectVertSize; //Vertical (y) size of rectangle
//----------------

//General variables
grass_number = numObjects; //Number of grass sprites inside the room
grass_sprite = spriteName; //Sprite used for the grass
...
grass_pattern = grassPattern; //Whether the grass should sway in a pattern

//These variables can also be changed later
grass_wind = windPower; //Power of the grass swaying
grass_speed = animationSpeed; //Speed of the grass animation
wind_hsp = extraHorizontalSpeed; //Extra horizontal speed of the wind
